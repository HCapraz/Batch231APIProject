...
public class Get10 extends HerOkuAppBaseUrl {
    /*
 Given
     https://restful-booker.herokuapp.com/booking/2099
 When
 ...
 */
    ...
    public void test1() {
        ...
        bunun icin Object data tipini Map data tipine cevirmemiz gerekiyor(Type casting)
        Ama bu tarz nested durumlarda jsonpath kullanarak bir json body icindeki dataya rahatlikla erisebiliriz
         */
